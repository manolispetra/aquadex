...
import {
  type Token, MON_NATIVE, WMON_TOKEN, AQUA_TOKEN,
...
export default function SwapWidget() {
  ...
  const [tokenOut, setTokenOut] = useState<Token>(AQUA_TOKEN);
  ...
  const parsedAmountIn = amountIn ? safeParse(amountIn, tokenIn.decimals) : BigInt(0);
      ...
      <div className="glass-card rounded-3xl p-4 shadow-[0_8px_48px_rgba(0,0,0,0.5)]">
        ...
        {wrongNetwork ? (
          ...
          <button onClick={handleApprove} disabled={btnLoading}
            ...
            {approving
              ? <span className="flex items-center justify-center gap-2"><RefreshCw size={15} className="animate-spin" />Approving...</span>
